    ...
    <div className="flex flex-col justify-center p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
      ...
      <div className="space-y-4 text-center divide-y dark:divide-gray-300">
        <div className="my-2 space-y-1">
          ...
          <p className="px-5 text-xs sm:text-base dark:text-gray-600">UserName : 
        ...
        <div className="flex justify-center pt-2 space-x-4 align-center">
          <a
            target="_blank"
            href={`https://github.com/${author.user.github_username}`}
            aria-label="GitHub"
          ...
          <a
           target="_blank"
            href={`https://twitter.com/${author.user.twitter_username}`}
            aria-label="Twitter"
            className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600"
          >
            <svg
